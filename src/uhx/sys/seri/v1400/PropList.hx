...
enum abstract PropList(String) to String {
    ...
    @:to public inline function asRange():uhx.sys.seri.Ranges {
        return switch this {
            ...
            case "OtherLowercase":
                new Ranges([170, 186, new Range(688, 696), new Range(704, 705), new Range(736, 740), 837, 890, new Range(7468, 7530), 7544, new Range(7579, 7615), 8305, 8319, new Range(8336, 8348), new Range(8560, 8575), new Range(9424, 9449), new Range(11388, 11389), new Range(42652, 42653), 42864, new Range(43000, 43001), new Range(43868, 43871), 67456, new Range(67459, 67461), new Range(67463, 67504), new Range(67506, 67514)]);
            ...
            case "SoftDotted":
                new Ranges([new Range(105, 106), 303, 585, 616, 669, 690, 1011, 1110, 1112, 7522, 7574, 7588, 7592, 7725, 7883, 8305, new Range(8520, 8521), 11388, new Range(119842, 119843), new Range(119894, 119895), new Range(119946, 119947), new Range(119998, 119999), new Range(120050, 120051), new Range(120102, 120103), new Range(120154, 120155), new Range(120206, 120207), new Range(120258, 120259), new Range(120310, 120311), new Range(120362, 120363), new Range(120414, 120415), new Range(120466, 120467), 122650]);
