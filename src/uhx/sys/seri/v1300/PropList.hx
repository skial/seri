...
enum abstract PropList(String) to String {
    ...
    @:to public inline function asRange():uhx.sys.seri.Ranges {
        return switch this {
            ...
            case "Ideographic":
                new Ranges([12294, 12295, new Range(12321, 12329), new Range(12344, 12346), new Range(13312, 19903), new Range(19968, 40956), new Range(63744, 64109), new Range(64112, 64217), 94180, new Range(94208, 100343), new Range(100352, 101589), new Range(101632, 101640), new Range(110960, 111355), new Range(131072, 173789), new Range(173824, 177972), new Range(177984, 178205), new Range(178208, 183969), new Range(183984, 191456), new Range(194560, 195101), new Range(196608, 201546)]);
            ...
            case "UnifiedIdeograph":
                new Ranges([new Range(13312, 19903), new Range(19968, 40956), new Range(64014, 64015), 64017, new Range(64019, 64020), 64031, 64033, new Range(64035, 64036), new Range(64039, 64041), new Range(131072, 173789), new Range(173824, 177972), new Range(177984, 178205), new Range(178208, 183969), new Range(183984, 191456), new Range(196608, 201546)]);
