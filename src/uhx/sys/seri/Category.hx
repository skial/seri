...
@:notNull @:forward @:forwardStatics enum abstract Category(GC) from GC {
    ...
    public var Mark_NonSpacing = Mn;
    public var Mark_SpacingCombining = Mc;
    public var Mark_Enclosing = Me;
    public var Number_DecimalDigit = Nd;
    public var Number_Letter = Nl;
    public var Number_Other = No;
